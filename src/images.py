"""Build the site's images from the recovered WordPress uploads.
...
IMAGES = [
    ...
    ('proj-greystone-park', '2025/04/PATHFINDER-1.png', PROJECT, [480, 750], (0.5, 0.5), BAND),
    ('proj-presbyterian-paving', '2025/06/PATHFINDER-5.png', PROJECT, [480, 750], (0.5, 0.5), BAND),
    ('proj-presbyterian-tarmac', '2025/06/PATHFINDER-4-1.png', PROJECT, [480, 750], (0.5, 0.5), BAND),
    ...
    ('prod-3d-arrow', '2025/04/WhatsApp-Image-2025-03-14-at-15.02.14_6863e7ea-Copy.jpg', CARD, [480, 756], (0.5, 0.5), None),
    ('prod-hexagonal', '2025/04/IMG-20250405-WA0017.jpg', CARD, [480, 765], (0.5, 0.62), None),
    ('prod-bone', '2025/04/IMG-20250314-WA0115.jpg', CARD, [480, 750], (0.5, 0.45), None),
